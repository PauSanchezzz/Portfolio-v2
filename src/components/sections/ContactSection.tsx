    ...
    <SectionContainer id="contact">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="text-center">
          <h3 className="text-xl font-semibold mb-6">{t.contact.connectWith}</h3>
          <div className="flex justify-center gap-4">
            <a
              href={CONTACT_INFO.github}
              target="_blank"
              rel="noopener noreferrer"
              className="w-14 h-14 rounded-full glass-hover flex items-center justify-center text-slate-300 hover:text-white group"
              aria-label="GitHub"
            >
